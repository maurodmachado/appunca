...
export default function FacultadEconomicasComponent({navigation}) {
  ...
  <Card.Title style={{fontSize:20, color: '#0F0F0F'}}> <Button icon={<FontAwesomeIcon icon={faArrowLeft} size={14} color="#ffffff" />} buttonStyle={{left:0, position:'relative', width: 20, height:20,  textAlignVertical:'center'}} onPress={() => {navegarAComponente('Escuela de Arqueologia')}}/> Facultad de Economicas <Button icon={<FontAwesomeIcon icon={faArrowRight} size={14} color="#ffffff" />} buttonStyle={{position:'relative', width: 20, height:20,  textAlignVertical:'center'}} onPress={() => {navegarAComponente('Facultad de Agrarias')}}/></Card.Title>
  ...
  <Text style={styles.textCard}>
    La Facultad de Tecnologia sostiene la formación docente a través de las carreras de profesorado. Es una de las facultades con mayor cantidad de carreras de grado y de postgrado y la mayor matrícula de la UNCa.
      ...
      <View style={styles.centeredView}>
          ...
          <Text style={styles.textCard}>Maestro Quiroga 51 (Planta Alta), San Fernando del Valle de</Text><Text style={styles.textCard}> Catamarca, Catamarca, CP: 4700</Text>
          <Text style={styles.textCardTitle}>Contacto</Text>
          <Text style={styles.textCard}>Tel: +54 383 4434645</Text>
          <Text style={styles.textCard}>Despacho Decanato: Interno 157</Text>
          <Text style={styles.textCard}>Unidad Alumnos: Interno 158</Text>
          <Text style={styles.textCard}>infofceya@eco.unca.edu.ar</Text>
          </View>
      </Overlay>
      <Button  
      type="outline"    
