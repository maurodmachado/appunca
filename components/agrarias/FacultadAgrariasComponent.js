...
export default function FacultadAgrariasComponent({navigation}) {
  ...
  <Card.Title style={{fontSize:20, color: '#0F0F0F'}}> <Button icon={<FontAwesomeIcon icon={faArrowLeft} size={14} color="#ffffff" />} buttonStyle={{left:0, position:'relative', width: 20, height:20,  textAlignVertical:'center'}} onPress={() => {navegarAComponente('Facultad de Economicas')}}/> Facultad de Agrarias <Button icon={<FontAwesomeIcon icon={faArrowRight} size={14} color="#ffffff" />} buttonStyle={{position:'relative', width: 20, height:20,  textAlignVertical:'center'}} onPress={() => {navegarAComponente('Facultad de Derecho')}}/></Card.Title>
  ...
  <Text style={styles.textCard}>
    La Facultad de Tecnologia sostiene la formación docente a través de las carreras de profesorado. Es una de las facultades con mayor cantidad de carreras de grado y de postgrado y la mayor matrícula de la UNCa.
      ...
      <Text style={{fontSize:20, fontWeight: 'bold'}}>Facultad de Ciencias Agrarias</Text>
          ...
          <Text style={styles.textCard}>Avenida Belgrano y Maestro Quiroga, San Fernando del Valle de</Text><Text style={styles.textCard}> Catamarca, Catamarca, CP: 4700</Text>
          <Text style={styles.textCardTitle}>Contacto</Text>
          <Text style={styles.textCard}>Tel: +54 383 4430504</Text>
          <Text style={styles.textCard}>Conmutador: +54 383 4435955</Text>
          <Text style={styles.textCard}>Fax: +54 383 4443050</Text>
          </View>
      </Overlay>
      <Button  
      type="outline"    
      ...
      onPress={() => Linking.openURL('http://agrarias.unca.edu.ar/ingreso-2021/')}
