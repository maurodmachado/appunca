...
export default function EscuelaArqueologiaComponent({navigation}) {
  ...
  const telefonoEscArqueologia = '3834383748';
  const emailEscArqueologia = 'escueladearqueologia@unca.edu.ar';
  const wspEscArqueologia = '543834545986';
  const textFacultad = 'La Escuela de Arqueologia sostiene la formación docente a través de las carreras de profesorado. Es una de las facultades con mayor cantidad de carreras de grado y de postgrado y la mayor matrícula de la UNCa. Es una de las facultades con mayor cantidad de carreras de grado y de postgrado y la mayor matrícula de la UNCa. Es una de las facultades con mayor cantidad de carreras de grado y de postgrado y la mayor matrícula de la UNCa.'
...
buttonStyle={{width: '100%', height:undefined, marginRight:5}} onPress={() => {navegarAComponente('Facultad de Humanidades')}}/> 

<View style={styles.alignVertical}>
<Text style={styles.textCartTitleStyle}>Escuela de Arqueología</Text> 
</View>
<Button icon={<FontAwesomeIcon icon={faArrowRight} size={normalize(16)} color="#ffffff" />} 
buttonStyle={{width: '100%', height:undefined, marginLeft:5 }} onPress={() => {navegarAComponente('Facultad de Economicas')}}/>
</Card.Title>
  ...
  {textFacultad}
    ...
    <View style={styles.buttonContainer}>
      ...
      <View style={styles.centeredView}>
          ...
          <Icon.Button name="envelope" backgroundColor="#1999d0" onPress={()=> Linking.openURL(`mailto: ${emailEscArqueologia}`)}>Email</Icon.Button>
          </View>
          <View style={styles.buttonWhitIcon}>
          <Icon.Button name="phone" backgroundColor="#1999d0" onPress={()=> Linking.openURL(`tel: ${telefonoEscArqueologia}`)}>Telefono</Icon.Button>     
          </View>
          <View style={styles.buttonWhitIcon}>
          <Icon.Button name="whatsapp" backgroundColor="#00bb2d" onPress={() => Linking.openURL(`https://api.whatsapp.com/send?phone=${wspEscArqueologia}`)}> Whatsapp</Icon.Button>
          </View>
          </View>
      </Overlay>
            <View style={styles.buttonTextStyle}>
