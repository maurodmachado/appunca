...
<Text style={styles.textCartTitleStyle}>Escuela de Arqueologia</Text> 
...
buttonStyle={{width: '100%', height:undefined, marginLeft:5 }} onPress={() => {navegarAComponente('Facultad de Economicas')}}/>
  ...
  La Facultad de Ciencias Exactas sostiene la formación docente a través de las carreras de profesorado. 
